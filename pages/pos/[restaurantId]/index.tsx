      ...
      <div className="flex min-h-screen w-full flex-col">
        ...
        {stage === 'sell' ? (
          <div className="flex flex-1 overflow-hidden">
            <div className="flex flex-1 flex-col border-r border-gray-200 bg-white">
              <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
                ...
                <button
                  ...
                  className="rounded-full border border-gray-200 px-4 py-2 text-xs font-semibold text-gray-700 lg:hidden"
                >
            ...
            <aside className="hidden w-[360px] flex-col bg-gray-50 lg:flex">
